...
/**
 * <code>CardboardHarness</code> wraps a jme application object and runs it on
 * Android Cardboard
 *
 * @author Kirill
 * @author larynx
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                AlertDialog dialog = new AlertDialog.Builder(CardboardHarness.this) // .setIcon(R.drawable.alert_dialog_icon)
                        .setTitle(finalTitle).setPositiveButton("Kill", CardboardHarness.this).setMessage(finalMsg).create();
                dialog.show();
            }
        });
    }
